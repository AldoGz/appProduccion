    <?php 
class Funciones {
    public static $DIRECTORIO_PRINCIPAL = "ItsidFact";
        ...
        $html = '
                    <html>
                        <head>
                            ...
                            <meta charset="utf-8">
                            <link rel="stylesheet" href="'.$_SERVER["HTTP_ORIGIN"]."/".Funciones::$DIRECTORIO_PRINCIPAL.'/vista/reportes/css/reportes.css"/>
 <link rel="stylesheet" href="'.$_SERVER["HTTP_ORIGIN"]."/".Funciones::$DIRECTORIO_PRINCIPAL.'/vista/reportes/css/reportes-pdf.css"/>
                        </head>
                        <body>';
        $html .= $htmlDatos;
        $html .= "</body>";
