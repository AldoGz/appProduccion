                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">
                        <div class="panel-heading"> 
                            <h4 style="margin-top: 0px; margin-bottom: 0px"> Mantenimiento de actividad </h4>            
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <a id="btnAgregar" class='btn btn-primary pull-right' style="margin-bottom: 10px" data-toggle="modal" href="#myModal" title="Nuevo actividad">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar" id="frm-grabar"  role="form">
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <input type="hidden" name="txtcodigo_actividad" id="txtcodigo_actividad" class="form-control input-sm" readonly=""/>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-8">
                                                     ...
                                                     <div class="col-xs-4">
                                                        Maquina
                                                        <select id="txtcodigo_maquina" name="txtcodigo_maquina" class="form-control input-sm">                                                            
                                                        </select>
                                                    </div>  
                                                </div>                                           
                                                <div class="row">
                                                    <div class="col-xs-4">
                                                        Cantidad hombre<input type="text" name="txtcantidad_hombres" id="txtcantidad_hombres" class="form-control input-sm" required="" style="text-transform:uppercase;"/>
                                                    </div>
                                                    <div class="col-xs-4">
                                                        Costo hora hombre<input type="text" name="txtcosto_hora_hombre_base" id="txtcosto_hora_hombre_base" class="form-control input-sm" required="" style="text-transform:uppercase;"/>
                                                    </div>
                                                    <div class="col-xs-4">
                                                        Cantidad horas maquina<input type="text" name="txtcantidad_hora_hombres" id="txtcantidad_hora_hombres" class="form-control input-sm" required="" style="text-transform:uppercase;"/>
                                                    </div>
                                                </div>
                                                <div class="row">
