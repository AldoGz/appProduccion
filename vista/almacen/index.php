                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">
                        <div class="panel-heading"> 
                            <h4 style="margin-top: 0px; margin-bottom: 0px"> Mantenimiento de almacen</h4>            
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">                                    
                                    <a id="btnAgregar" class='btn btn-primary pull-right' style="margin-bottom: 10px" data-toggle="modal" href="#myModal" title="Nuevo almacen">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar" id="frm-grabar"  role="form">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-xs-2">
                                                        <input type="hidden" name="txtcodigo_almacen" id="txtcodigo_almacen" class="form-control input-sm" readonly=""/>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        Dirección<input type="text" name="txtdireccion" id="txtdireccion" class="form-control input-sm" required="" style="text-transform:uppercase;"/>
                                                    </div>
                                                </div>
