                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">
                        <div class="panel-heading"> 
                            <h4 style="margin-top: 0px; margin-bottom: 0px"> Mantenimiento de cargo </h4>            
                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar" id="frm-grabar"  role="form">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-xs-2">
                                                        <input type="hidden" name="txtcodigo_cargo" id="txtcodigo_cargo" class="form-control input-sm" readonly=""/>
