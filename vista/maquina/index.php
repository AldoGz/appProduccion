                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">
                        <div class="panel-heading"> 
                            <h4 style="margin-top: 0px; margin-bottom: 0px"> Mantenimiento de maquina </h4>            
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <a id="btnAgregar" class='btn btn-primary pull-right' style="margin-bottom: 10px" data-toggle="modal" href="#myModal" title="Nuevo maquina">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar" id="frm-grabar"  role="form">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <input type="hidden" name="txtcodigo_maquina" id="txtcodigo_maquina" class="form-control input-sm" readonly=""/>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        Descripción
                                                        <textarea class="form-control input-sm" rows="5" name="txtdescripcion" id="txtdescripcion" style="text-transform:uppercase;"></textarea>
                                                    </div>
                                                </div>                                                
                                                <div class="row">
                                                    <div class="col-xs-4">
                                                        Costo uso<input type="text" name="txtcosto" id="txtcosto" class="form-control input-sm" required="" />
                                                    </div>
                                                </div>
