                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">
                        <div class="panel-heading"> 
                            <h4 style="margin-top: 0px; margin-bottom: 0px"> Mantenimiento de plan de producción </h4>            
                        </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar" id="frm-grabar"  role="form">
                                            <div class="modal-body">                                                
                                                <div class="row">
                                                    <div class="col-xs-6">
                                                        Nombre<input type="text" name="txtnombre" id="txtnombre" class="form-control input-sm" readonly=""/>                                                        
                                                    </div>
                                                    <div class="col-xs-6">
                                                        Fecha inicio<input type="text" name="txtfecha" id="txtfecha" class="form-control input-sm" readonly="" value="<?php echo date('d/m/Y'); ?>"/>
                                                    </div>
                                                </div>                                                
                                            </div>
