                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">
                        <div class="panel-heading"> 
                            <h4 style="margin-top: 0px; margin-bottom: 0px"> Mantenimiento de variables constantes </h4>            
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-xs-12">                                    
                                    <a id="btnAgregar" class='btn btn-primary pull-right' style="margin-bottom: 10px" data-toggle="modal" href="#myModal" title="Nuevo variable constante">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar" id="frm-grabar"  role="form">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-xs-2">
                                                        <input type="hidden" name="txtcodigo_constante" id="txtcodigo_constante" class="form-control input-sm" readonly=""/>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        Nombre<input type="text" name="txtdescripcion" id="txtdescripcion" class="form-control input-sm" required=""/>
                                                    </div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        Descripción<textarea name="txtinformacion" id="txtinformacion" class="form-control input-sm" required=""></textarea>
                                                    </div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        Valor<input type="text" name="txtvalor" id="txtvalor" class="form-control input-sm" required=""/>
                                                    </div>
                                                </div>
