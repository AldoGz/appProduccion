                ...
                <div class="right_col" role="main">
                    ...
                    <div class="panel panel-default panel-icr-blue" id="moduleDetailsPanel">  
                        <div class="panel-body">
                            ...
                            <div class="col-xs-12" id="blk-listado-pedido">
                              <div class="x_panel">
                                <div class="x_title">
                            ...
                            <div class="col-xs-12" id="blk-listado-requerimiento-interno">
                              <div class="x_panel">
                                <div class="x_title">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form name="frm-grabar-requisitos" id="frm-grabar-requisitos"  role="form">
                                          <div class="modal-body">                                            
                                              ...
                                              <div class="row">
                                                  <div class="col-xs-12">
                                                    Observaciones<textarea class="form-control input-sm" rows="2" name="txtmotivo" id="txtmotivo"></textarea>                                                    
                                                  </div>
                                              </div>
                                              <br> 
                                              <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <ul class="nav nav-tabs">                                        
                                        <li class="active"><a data-toggle="tab" href="#realizar">Materia Prima Fundición</a></li>
                                        <li><a data-toggle="tab" href="#mispedidos">Materia Prima Acabado</a></li>
                                    </ul>
                                            ...
                                            <div class="col-xs-12">
                                              <b>Materia Prima Fundición</b>
                                                <table class="table table-responsive">
                                                  ...
                                                  <tbody id="pre-mostrar-fundicion-mp">
                                                  </tbody>
                                                </table>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xs-12">
                                              <b>Materia Prima Acabado</b>
                                               <table class="table table-responsive">
                                                ...
                                                <tbody id="pre-mostrar-acabado-mp">
                                                </tbody>
                                              </table>
                                          </div>
                                        </div>
                                          ...
                                          <div class="row">
                                            <div class="panel panel-default">
                                              <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                      Piedra Caliza (1 Kg):<h4 id="p_va1"></h4>
                                                    </div>
                                                    <div class="col-sm-4">
                                                      Leña (1 Kg):<h4 id="p_va2"></h4>
                                                    </div>
                                                    <div class="col-sm-4">
                                                      Carbon (1 Kg):<h4 id="p_va3"></h4>
                                                    </div>                                                    
                                                </div>
                                              </div>
                                            </div>
                              ...
                              <div class="col-sm-8 col-xs-12">
                                <table class="table table-responsive">
                                  <thead >
                                    ...
                                    <th class="text-center">% Buenas</th>
                                    <th class="text-center">Retorno Chatarra</th>  
                                    <th class="text-center">OPC</th>
                                  </thead>
